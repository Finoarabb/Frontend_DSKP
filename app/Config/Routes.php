...
$routes->post('dashboard', 'Login::dashboard');
...
$routes->get('disposableUser/(:num)', 'User::disposableUser/$1');
$routes->post('editLetter/(:num)', 'Letter::editLetter/$1');
$routes->post('monthlyLetter', 'Letter::monthlyLetter');
